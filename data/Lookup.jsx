...
export default {
  ...
  SIGNIN_HEADING: "Continue With Code Buddy",
  SIGNIN_SUBHEADING:
    "To use Code Buddy you must log into an existing account or create one.",
  SIGNIn_AGREEMENT_TEXT:
    "By using Code Buddy, you agree to the collection of usage data for analytics.",
